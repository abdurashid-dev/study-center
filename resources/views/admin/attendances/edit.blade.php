            ...
            <div class="flex gap-2">
                ...
                @if($students->count() > 0)
                    <button type="submit"
                            ...
                            class="block text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-blue-800 dark:focus:bg-green-700">
