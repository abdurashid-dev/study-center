<x-app-layout xmlns:livewire="http://www.w3.org/1999/html">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="time-rows">
                                    ...
                                    <select style="margin: 4px 0 8px; padding: 8px" name="days[]" class="form-select appearance-none
                                        ...
                                        <option value="">Hafta kunlari</option>
                                        <option value="Dushanba" @if($time->day == 'Dushanba') selected @endif>Dushanba
                                        </option>
                                        <option value="Seshanba" @if($time->day == 'Seshanba') selected @endif>Seshanba
                                        </option>
                                        <option value="Chorshanba" @if($time->day == 'Chorshanba') selected @endif>
                                            Chorshanba
                                        </option>
                                        <option value="Payshanba" @if($time->day == 'Payshanba') selected @endif>
                                            Payshanba
                                        </option>
                                        <option value="Juma" @if($time->day == 'Juma') selected @endif>Juma</option>
                                        <option value="Shanba" @if($time->day == 'Shanba') selected @endif>Shanba
                                        </option>
                                        <option value="Yakshanba" @if($time->day == 'Yakshanba') selected @endif>
                                            Yakshanba
                                        </option>
                                    </select>
                                ...
                                <div class="time-rows">
                                    ...
                                    <input name="times[]" type="time" value="{{$time->time}}"
                                ...
                                <button type="button"
                                        class="existRemoveBtn block mt-4 text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800 dark:focus:bg-red-700">
    ...
    @section('scripts')
        <script>
            ...
            let existRemoveBtn = document.querySelectorAll('.existRemoveBtn');
            existRemoveBtn.forEach((item) => {
                item.addEventListener('click', function () {
                    item.parentElement.remove()
                })
            })
            ...
            addNew.addEventListener('click', createDiv)
        </script>
    @endsection
</x-app-layout>
