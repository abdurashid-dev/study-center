<div>
    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="#" title="O'chirilgan o'quvchilar soni"
                        ...
                        @forelse($students as $student)
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="py-3 px-6 whitespace-nowrap">
                                    ...
                                    <form action="{{route('students.delete', $student)}}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
                                                class="restore-btn text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 focus:outline-none dark:focus:ring-red-800">
