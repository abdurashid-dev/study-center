...
final class StudentPaymentSingleTable extends PowerGridComponent
{
    use ActionButton;
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('payment')
            ->addColumn('comment')
            ->addColumn('created_at_formatted', fn(StudentPayment $model) => Carbon::parse($model->created_at)->format('d/m/Y H:i:s'))
            ->addColumn('updated_at_formatted', fn(StudentPayment $model) => Carbon::parse($model->updated_at)->format('d/m/Y H:i:s'));
    }
